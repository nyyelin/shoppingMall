<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
      <i class="bi bi-box-seam"></i><span>Item</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
  ...
  <li class="nav-item">
    ...
    <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="#">
          <i class="bi bi-circle"></i><span>Main Subcategory</span>
        </a>
      </li>
      <li>
        <a href="#">
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#">
      <i class="bi bi-star"></i><span>Rating</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#">
      <i class="bi bi-book"></i><span>Review</span>
    </a>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#">
      <i class="bi bi-credit-card-2-back"></i><span>Payment</span>
    </a>
  </li>
</ul>
